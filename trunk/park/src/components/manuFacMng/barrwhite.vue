<template>
  <div id="serviceList">
    ...
    <div class="select">
      <span>设备编号：</span>
      <el-input v-model="search.roadGateId"
                clearable
      ...
      <div class="total">
        <el-row>
          ...
          <el-col :span="12">
            ...
            <span class="spanClassT">
              <span class="aKey">*</span>用户编码：</span>
            <el-input :disabled="true"
                      v-model="add.usercode"
                      clearable
                      placeholder="请输入内容"></el-input><br /><br />

            <span class="spanClassT">
              <span class="aKey">*</span>有效标记：</span>
            <el-select v-model="add.nbenable"
                       placeholder="请选择">
              <el-option v-for="item in numtable"
                         :key="item.value"
                         :label="item.type"
          ...
          <el-col :span="12">
            ...
            <span class="spanClassT">
              <span class="aKey">*</span>黑名单：</span>
            <el-select v-model="add.nisblacklist"
                       placeholder="请选择">
            ...
            <span class="spanClassT">
              <span class="aKey">*</span>时间段匹配：</span>
            <el-select v-model="add.nisusingtimeseg"
                       placeholder="请选择">
            ...
            <el-date-picker v-model="add.startTime"
                            type="datetime"
                            placeholder="选择日期时间"
            ...
            <el-date-picker v-model="add.endTime"
                            type="datetime"
                            placeholder="选择日期时间"
                            value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker><br /><br />
          </el-col>
    ...
    <el-dialog title="修改"
      ...
      <el-input :disabled="false"
                v-model="change.roadGateId"
                clearable
                placeholder="请输入内容"></el-input><br /><br />

      <span class="spanClassT">
        <span class="aKey">*</span>过期时间：</span>
      <el-date-picker v-model="change.outTime"
                      type="datetime"
                      placeholder="选择日期时间"
                      value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker><br /><br />
