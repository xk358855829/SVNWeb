      ...
      <el-table class='oyTable'
        ...
        <el-table-column prop=""
          ...
          <template slot-scope="scope">
            ...
            <el-tooltip v-if="scope.row.type==1"
                        class="item"
                        effect="dark"
                        content="权限"
                        placement="top">
...
export default {
  ...
  methods: {
    ...
    searchClick () {
      ...
      axios({
        method: 'post',
        // url:this.$store.state.url+'/s_user/list?page='+this.paging.page+'&pageSize='+this.paging.pageSize+'&dealer='+sessionStorage.getItem('dealer')
        url: this.$store.state.url + '/s_user/list',
        // url:'http://192.168.2.110:8080/ZFBrake/s_user/list',
