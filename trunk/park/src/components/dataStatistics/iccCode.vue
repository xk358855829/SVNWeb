<template>
  <div id="offReport">
    ...
    <div class="select">
      <span>ICCID：</span>
      <el-input v-model="search.cardnumber"
                clearable
                placeholder="请输入内容"></el-input>
      <span>设备编号：</span>
      <el-input v-model="search.concode"
                clearable
                placeholder="请输入内容"></el-input>
      <span>流量卡状态：</span>
      <el-select v-model="search.stateType"
                 placeholder="请选择">
        <el-option>未选择</el-option>
        <el-option v-for="item in cardaffiliation"
                   :key="item.id"
                   :label="item.type"
    ...
    <div class="select">
      <span>服务商：</span>
      <el-select v-model="search.operid"
                 placeholder="请选择">
        <el-option>未选择</el-option>
        <el-option v-for="item in cardonline"
                   :key="item.id"
                   :label="item.type"
                   :value="item.type"></el-option>
      </el-select>
