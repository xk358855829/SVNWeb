<template>
  <div id="faultList">
    ...
    <div class="select">
      ...
      <span>停车场名称：</span>
      <el-select v-model="search.parkingName"
                 filterable
                 placeholder="请选择">
      ...
      <el-select v-model="search.refund_type"
                 placeholder="请选择">
        <el-option>未选择</el-option>
        <el-option v-for="item in this.$store.state.paytypes"
                   :key="item.id"
                   :label="item.type"
                   :value="item.type"></el-option>
      </el-select><br/><br/>
      <span>订单流水号：</span>
      <el-input v-model="search.out_trade_no"
                clearable
                placeholder="请输入内容"></el-input>
          ...
          <template slot-scope="scope">
            <!-- <el-popover> -->
              ...
              <div slot="reference"
                ...
                <div>
                  <img v-if="scope.row.refund_type==5"
                       src="../../../static/image/cash.png"
                       alt="">
                  <img v-if="scope.row.refund_type==2"
                       src="../../../static/image/alipay.png"
                       alt="">
                  <img v-if="scope.row.refund_type==3"
                       src="../../../static/image/wechat.png"
                       alt="">
                  <img v-if="scope.row.refund_type==1"
    ...
    <el-dialog title="查看"
      ...
      <div class="letg">
        <el-row>
          <el-col :span="12">
            <div class="grid-content">订单号码：</div>{{look.out_trade_no}}</el-col>
          <el-col :span="12">
            <div class="grid-content">退款理由：</div>{{look.refund_reason}}</el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <div class="grid-content">退款金额：</div>{{look.refund_fee}}</el-col>
          <el-col :span="12">
            <div class="grid-content">退款时间：</div>{{look.date}}</el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <div class="grid-content">退款流水号：</div>
            <div>{{look.out_refund_no}}</div>
          </el-col>
          <el-col :span="12">
            <div class="grid-content">退款状态：</div>{{status}}</el-col>
        </el-row>
        <el-row>
    ...
    searchClick () {
      ...
      if (that.search.out_trade_no) {
        ...
        if (that.search.parkingName) {
          data.parkingName = that.search.parkingName
        }
