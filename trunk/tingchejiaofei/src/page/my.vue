				...
				<li>
					<div class="talos">
						...
						<div style="width:0.5rem;height:0.5rem;margin-top:0.04rem;">
							<!-- <i></i> -->
							<img :src='zl' alt="" style="width:100%;height:100%;">
						</div>
					</div>
				</li>
				<li>
...
<script>
	...
	import {huoqus} from '../components/api/api.js'
	export default {
		name: 'my',
		data() {
			return {
		...
		mounted: function() {
			...
			this.zl=localStorage.getItem('headimgurl')
			// let data={
			// 	openId:'oOKex1EuMmqul_o-d_fwltu27MTI'
			// }
			// huoqus(data).then(res=>{
			// 	console.log(res)
			// })
		}
	}
...
<style lang="scss" scoped>
	...
	.helloA{position: fixed;top:0;left: 0;width: 100%;height:100%;background:#efefef;}
