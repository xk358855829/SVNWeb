  ...
  <el-card shadow="never" class="aui-card--fill">
    <div class="mod-message__mail-template">
      ...
      <el-table v-loading="dataListLoading" :data="dataList" border ref="table" style="width: 100%;">
        ...
        <el-table-column prop="warningMsg" label="报警信息" align="center"></el-table-column>
        ...
        <!-- <el-table-column :label="$t('handle')" fixed="right" align="center" width="80">
          <template slot-scope="scope">
            <el-button type="text" size="small" @click="deleteHandle(scope.row.did)">{{ $t('delete') }}
            </el-button>
          </template>
        </el-table-column> -->
      </el-table>
...
import { getalarmInfo } from "../../../api/api";
