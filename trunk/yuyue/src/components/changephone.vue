<template>
    <div>
        <div class="head-top">
            <div>
                <span>手机号</span>
                <input type="text"  placeholder="请输入11位手机号码" v-model="phone">
            </div>
            <div>
                <span>验证码</span>
                <input type="text" placeholder="请输入短信验证码" style="width:43%;" v-model="mess">
...
<style lang="scss" scoped>
    ...
    .head-top{@include wh(91%,1.16rem);border-radius: 5px;background: #fff;margin:0 auto;margin-top:0.32rem;}
    ...
    p{@include wh(0.78rem,0.32rem);background: #0ccf5f;color: #fff;line-height: 0.32rem;text-align: center;margin:0.1rem;border-radius: 5px;}
