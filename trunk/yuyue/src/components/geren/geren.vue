<template>
	<div class="hello" style="padding-top:0.32rem;">
		...
		<gfooter :Wacth="Wacth" :Colors="Colors"></gfooter>
...
<style lang="scss" scoped>
	...
	.header{@include wh(94%,2.06rem);
	background: #fff;border-radius: 5px;
	margin:0 auto;display: flex;
	margin-bottom:0.44rem;}
	.header div:nth-child(1){@include wh(1.44rem,1.44rem);border-radius: 50%;margin:0.3rem 0.30rem;}
	.header div:nth-child(2){@include wh(69%,2.06rem);line-height: 2.06rem;font-size: 18px;font-family: 'PingFang-SC-Regular';@include sc(18px,rgb(48,48,48))}
	.header div:nth-child(3){@include wh(0.14rem,0.24rem);line-height: 2.06rem;}
	img{vertical-align: middle;@include wh(100%,100%);}
	ul{width: 94%;margin:0 auto;background: #fff;border-radius: 5px;}
	li{@include wh(100%,1.14rem);line-height: 1.14rem;font-family: 'PingFang-SC-Regular';@include sc(16px,rgb(48,48,48));display: flex;justify-content: space-between;
	border-bottom: 1px solid rgb(239,239,239);}
	li div:nth-child(1){text-indent: 0.3rem;}
	li div:nth-child(2){width: 20%;height: 100%;text-align: right;margin-right: 0.3rem;}
	.header img{@include wh(100%,100%);}
	img{@include wh(0.14rem,0.24rem);
