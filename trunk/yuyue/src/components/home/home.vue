<template>
	<div class="box">
		...
		<gfooter @ab="abg" :Wacth="Wacth" :Colors="Colors"></gfooter>
	</div>
</template>
...
<style lang="scss" scoped>
	...
	.box{@include wh(100%,100%);background: #f2f2f2;}
	header div{@include wh(6.86rem,3.6rem);margin:0 auto;margin-bottom:0.44rem;padding-top:0.32rem;}
	header div img{@include wh(100%,100%);}
