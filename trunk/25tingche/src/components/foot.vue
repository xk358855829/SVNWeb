  ...
  <section class="pkey-contain">
    ...
    <section class="pkey-keyboard">
      <header class="pkey-header2">
        <label class="pkey-chacelbtn"
               @click="closewin">取消</label>
        <label class="pkey-okbtn"
               @click="checkplate">完成</label>
      </header>
      <section class="pkey-keyscontain">
        <ul>
          <li v-show="txtboardshow"
            ...
            <span v-show="index==cartxt.length-1"
                  @click="plate=plate.substr(0, plate.length-1)">&nbsp;</span>
          </li>
          <li v-show="numboardshow"
              v-for="(item,index) in numtxt">
            <span v-show="index==cartxt.length-1"
                  @click="txtboardshow=true,numboardshow=false">字</span>
            <label v-for="(items,indexi) in item"
