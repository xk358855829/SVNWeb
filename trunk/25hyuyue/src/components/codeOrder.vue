  ...
  <div id="codeOrder">
    ...
    <div class="parkingInformation">
      <p>
        <span>
          <span><img class="imgs"
                 src="../../static/image/wz.png" /></span>
          <span class="cLeft">停车位置：</span>
        </span>
      ...
      <p style="position: relative;">
        ...
        <ul v-if="brand==1"
          ...
          <li @click="brandN(index)"
              v-for="(brand,index) in brandnameList">{{brand.brandname}}</li>
          <li>
      ...
      <p class="mtime">
        <span>
          <span><img class="imgs"
                 src="../../static/image/jssj.png" /></span>
          <span class="cLeft">结束时间：</span>
        </span>
        <span class="ktimeP"
              @click="timeClick('m')">
      ...
      <p>
        <span>
          <span><img class="imgs"
                 src="../../static/image/yjsf.png" /></span>
          <span class="cLeft">预计收费：</span>
        </span>
