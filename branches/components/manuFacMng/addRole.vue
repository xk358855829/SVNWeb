	...
	<div id="addRole">
			...
			<el-table class='oyTable' :data="tableData" style="width: 100%">
				...
				<el-table-column prop="" label="操作" width='150'>
					<template slot-scope="scope">
						...
						<el-tooltip v-if="scope.row.userTypeId == 1" class="item" effect="dark" content="删除" placement="top">
		...
		<el-dialog title="新增" :visible.sync="universal.add">
			<div>
				...
				<el-input class="textareaWidth" type="textarea" :rows="5" v-model="add.roleDescribe" clearable placeholder="请输入内容"></el-input><br /><br />
		...
		<div class="footer">
			<pageSize v-on:code="getList" :messages="totals"></pageSize>	
		</div>
	</div>
</template>
