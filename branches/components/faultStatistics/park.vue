<template>
	<div id="faultList">
		...
		<div class="select">
			...
			<span>升降状态：</span>
			<el-select v-model="search.fauModes" placeholder="请选择">
				<el-option value="">未选择</el-option>	
				<el-option v-for="item in upstatus" :key="item.id" :label="item.type" :value="item.id"></el-option>
			</el-select>
		</div>
		<div class="select">
		...
		<div class="Content">
			<el-table class='oyTable' :data="tableData" style="width: 100%">
				...
				<el-table-column label="车位名称" width="">
				...
				<el-table-column label="租用状态" width="">
					<template slot-scope="scope">
				        <el-popover trigger="hover" placement="top">
				        	<p  class="TsMaxWidth">{{ scope.row.alias }}</p>
				        	<div slot="reference" class="name-wrapper">
				...
				<el-table-column label="升降状态" width="">
					<template slot-scope="scope">
				        <el-popover trigger="hover" placement="top">
				...
				<el-table-column label="关联停车场" width="">
					<template slot-scope="scope">
				        <el-popover trigger="hover" placement="top">
				...
				<el-table-column label="关联设备" width="">
					<template slot-scope="scope">
				        <el-popover trigger="hover" placement="top">
				...
				<el-table-column label="在线状态" width="">
					<template slot-scope="scope">
				        <el-popover trigger="hover" placement="top">
				...
				<el-table-column label="是否包月" width="">
					<template slot-scope="scope">
						<el-popover trigger="hover" placement="top">
				...
				<el-table-column label="电量" width="">
					<template slot-scope="scope">
						<el-popover trigger="hover" placement="top">
		...
		<el-dialog title="修改" :visible.sync="universal.change">
			<div>
				<span class="spanClass">设备ID：</span>
				<el-input :disabled="true" v-model="change.id" clearable placeholder="请输入内容"></el-input><br /><br />
				
				<span class="spanClass">车位名称：</span>
				<el-input :disabled="true" v-model="change.alias" clearable placeholder="请输入内容"></el-input><br /><br />

				<span class="spanClass">关联停车场：</span>
				<el-select v-model="search.fauModecar" placeholder="请选择">
					<el-option v-for="item in relevance" :key="item.id" :label="item.type" :value="item.id" ></el-option>
				</el-select><br /><br />
			</div>
			<div slot="footer" class="dialog-footer">
