  ...
  <div id="money">
    ...
    <div class="boxB">
      <p>
        ...
        <span>{{detailed.lockalias}}</span>
      </p>
      <p>
        <span class="left">车&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;牌</span>
        <span>{{detailed.carnumber}}</span>
      </p>
      <p>
        <span class="left">开始时间</span>
        <span>{{detailed.timeS}}</span>
      </p>
      <p>
        <span class="left">结束时间</span>
        <span>{{detailed.timeE}}</span>
      </p>
      <p>
        <span class="left">停车时长</span>
        <span>{{detailed.longTime}}小时</span>
      </p>
      <p>
        <span class="left">支付金额</span>
        <span style="color: #FF0000;">{{detailed.amount}}元</span>
      </p>
    </div>

    <div v-if="detailed.state!=0"
         @click="settlementClick()"
         class="control">付款</div>
    <div v-if="detailed.state==0"
         id="popup">
      <!--<div id="popup">-->
      <div class="popupBox">
        ...
        <!--<p @click="nextOk()">确定</p>-->
        <p class="complete">
          <span @click="nextOk()">返回首页</span>
          <span @click="nextOnce()">再来一单</span>
        </p>
      </div>
    </div>
  </div>
...
.complete span:nth-of-type(1) {
  border-bottom-left-radius: 0.1rem;
}
.complete span:nth-of-type(2) {
  border-bottom-right-radius: 0.1rem;
}
.complete span:active {
  background-color: #f68b1b;
  color: #ffffff;
}
</style>