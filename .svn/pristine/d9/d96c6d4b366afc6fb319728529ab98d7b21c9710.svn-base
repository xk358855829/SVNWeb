...
<style scoped="scoped">
.tit{text-align: center;height: 2.2rem;line-height: 2.2rem;border-bottom: 1px solid #D8D8D8;color: #787878;}
.date{display: flex;height: 2rem;line-height: 2rem;border-bottom: 1px solid #D8D8D8;justify-content: space-between;padding-left:0.5rem;font-size: 0.56rem}
.date>span:nth-of-type(1){color: #F68B1B;border-right:1px solid #D8D8D8 ;padding-right: 0.5rem;}
...
.next .nextOk,.nextNo{width: 100%;margin: 0 1rem; height: 1.76rem;background-color: #F68B1B;border-radius:0.2rem ;text-align: center;line-height: 1.76rem;color: #FFFFFF;font-size: 36px;margin-top: 0.8rem;}
...
.next>.nextNo{background-color: #d9d9d9;color: #FFFFFF;}
	...
	.popupBox p{height: 1.2rem;line-height: 1.2rem;font-size:28px;color: #F68B1B;}
