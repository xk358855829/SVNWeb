  ...
  <div id="equipmentList">
    <div class="header">
      <div class="headerTitle">
        <router-link class="router-link-active" to="/pageHome/magnetismList" tag="span">地磁管理</router-link>
        <router-link to="/pageHome/magnetismRecord" tag="span">设备记录</router-link>
      </div>
    </div>
    <div class="select">
      <!-- <span>停车场名称：</span>
...
export default {
  ...
  methods: {
    ...
    handleSearchClick() {
      ...
      axios({
        method: 'post',
        url: that.$store.state.magnetism_url + '/geomagnetismEquipment/selectGeomagnetismEquipment',
