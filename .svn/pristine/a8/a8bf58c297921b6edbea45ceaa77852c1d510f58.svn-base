<template>
  <div id="add">
    <div class="select">
      ...
      <span>路径名称：</span>
      <el-input v-model="menuPagename"
                clearable
                placeholder="请输入内容"></el-input>
      <span>菜单等级：</span>
      <el-select @change='levelChange'
                 v-model="level"
                 placeholder="请选择">
    ...
    <div class="select">
      <span>图片名称：</span>
      <el-input v-model="menuAddress"
                clearable
                placeholder="请输入内容"></el-input>
      <span>排序数字：</span>
      <el-input v-model="menuSort"
                clearable
                placeholder="请输入内容"></el-input>
      <span>菜单关联：</span>
      <el-select v-model="associated"
                 filterable
                 placeholder="请选择">
        <el-option v-for="item in associatedList"
                   :key="item.menuId"
                   :label="item.menuName"
