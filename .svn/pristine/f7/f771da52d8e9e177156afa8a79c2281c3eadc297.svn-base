<template>
  <div style="width:100%;background:#efefef;overflow: scroll;" class="rating_page">
    <ul class="recordli" style="padding-top:0.1rem;">
      <li v-for="item in uncompleteList" style="height:1.1rem;" :key="item.id">
        <h5 style="justify-content: space-between;">
          <span
            style="font-size:0.13rem;    color: #333333;"
        ...
        <div class="la" style="font-size:0.13rem;    color: #787878;">
          <div>
            <div style="margin-top:0.1rem;margin-left:0.25rem;">
              <i class="s" style="margin-right:0.1rem;"></i>
              车主姓名: {{item.name}}
    ...
    <div v-if="imgal" style="padding-top:1rem;z-index:22;">
