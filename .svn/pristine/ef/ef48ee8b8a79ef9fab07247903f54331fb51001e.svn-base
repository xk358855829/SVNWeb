      ...
      <ul>
        ...
        <li @click="mycar">
          <div class="talos">
            ...
            <input type="text"
                   v-model="aiche"
                   style="width:67%;border:none;outline:none;text-align:right;">
            <div class="imgat"><img src="../../../static/image/arrow.png"
                   alt=""></div>
          </div>
        </li>
