	...
	<div id="addRole">
		...
		<el-col :span="8">
			<div class="select">
				...
				<el-input v-model="name" clearable placeholder="请输入内容"></el-input>
				...
				<span>网站背景：</span><br><br>
				<div style="width: 200px;border:1px solid #CCCCCC;margin-left: 5px;height:112px">
		...
		<!-- <div slot="footer" class="dialog-footer">
			<!-- <el-button type="success" class="oyButton" @click="personal = false">取消</el-button> -->
			<!-- <el-button class="oyButton" @click="changeData">保存</el-button> -->
			<!-- <el-button type="success" class="oyButton" @click="changePassWord">保存</el-button> -->
		<!-- </div> -->
	...
	export default {
		...
		mounted: function() {
			...
			axios({
				...
				data:Qs.stringify({userId:localStorage.getItem('userId')})
...
<style scoped="scoped">
  ...
  .logo{
	...
	.cun{float: left;margin-top:53px;}
	.cuntwo{margin-top:278px!important;}
	.cunthree{margin-top:278px!important;}
