  ...
  <div id="login">
    <div class="loginHeader">
      <div class="content">
        ...
        <div class="login">
          <router-link to='page'>平台首页</router-link>
        </div>
      </div>
    </div>
    <ul>
      ...
      <div class="content clearfix">
        ...
        <div class="clearfix loginContentLogin">
          ...
          <div class="additional clearfix">
            <div>
              <div v-if='memory===0'
                   @click="memoryClick"></div>
              <div @click="memoryClick"
                   class="col"
                   v-if='memory===1'></div>&nbsp;&nbsp;
              <span>记住密码</span>
            </div>
            <div>
              <router-link to='aaa'>找回密码</router-link>
            </div>
          </div>
          <div>
            <button class="button"
      ...
      <div class="content">
        <ul>
          <li>
            <p>联系方式</p>
            <p class="p">
              <img src="../../static/image/icon-phone_10.png" />
              <span>{{data.conPhot}}</span>
            </p>
            <p class="p">
              <img src="../../static/image/icon-foxmail_20.png" />
              <span>{{data.contact}}</span>
            </p>
            <p class="p">
              <img src="../../static/image/icon-email_26.png" />
          ...
          <li>
            <p>所在位置</p>
            <p class="mapF">
              <img @mouseenter="mapImg(1)"
                   @mouseleave="mapImg(0)"
                   src="../../static/image/map_07.png" />
              <span class="mapS"
                    id="allmap"></span>
            </p>
          </li>
          <li>
            <p>微信公众号</p>
            <p class="mpF">
              <img @mouseenter="mapImg(3)"
                   @mouseleave="mapImg(2)"
                   src="../../static/image/vmsg_17.png" />
...
export default {
  ...
  mounted: function () {
    ...
    this.userpass = sessionStorage.getItem('passWord');
    this.searchClick();
...
.loginContent > .content > div:nth-of-type(1) {
  float: left;
  margin-left: 80px;
}
.loginContent > .content > div:nth-of-type(2) {
  float: right;
  margin-right: 80px;
}
.loginContent > .content > div > img {
  width: 410px;
}
.loginContentLogin {
...
.pass > div:nth-of-type(1) {
  padding-left: 10px;
}
.pass > div:nth-of-type(2) {
  margin: 0 20px;
  color: #dcdcdc;
}
.pass > div:nth-of-type(3) > input {
  border: none;
  width: 240px;
}
.code {
...
.code > .codeCon > div:nth-of-type(1) {
  padding-left: 10px;
}
.code > .codeCon > div:nth-of-type(2) {
  margin: 0 20px;
  color: #dcdcdc;
}
.code > .codeCon > div:nth-of-type(3) > input {
  border: none;
}
.code > .codeCode {
...
.additional > div:nth-of-type(1) {
  float: left;
  line-height: 20px;
}
.additional > div:nth-of-type(1) > div {
  float: left;
  width: 18px;
  height: 18px;
  border: 1px solid #dcdcdc;
...
.additional > div:nth-of-type(2) > a {
  color: #a2cc6d;
}
.loginFooter > .content > ul > li {
  float: left;
  width: 25%;
  text-align: center;
  padding-top: 85px;
...
.loginFooter > .content > ul > li:nth-of-type(1) > .p {
  height: 28px;
  display: flex;
  justify-content: center;
}
.loginFooter > .content > ul > li:nth-of-type(1) > p:nth-of-type(1) {
  padding-bottom: 10px;
}
.loginFooter > .content > ul > li:nth-of-type(1) > .p > img {
  margin: 4px;
}
.loginFooter > .content > ul > li:nth-of-type(1) > .p > span {
  line-height: 28px;
  font-size: 14px;
}
.loginFooter > .content > ul > li:nth-of-type(2) > p:nth-of-type(1) {
  padding-bottom: 35px;
}
.loginFooter > .content > ul > li:nth-of-type(2) > .p {
  color: #323232;
  font-size: 14px;
}
.loginFooter > .content > ul > li:nth-of-type(3) > p:nth-of-type(1) {
  padding-bottom: 20px;
}
.mapF {
  position: relative;
