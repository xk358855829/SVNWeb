<template>
    <div style="width:100%;height:100%;background:#fff;">
        <div class="table" :style="{backgroundImage:'url('+img+')',backgroundSize:'100% 100%'}">
            <p style="font-size:20px">{{e}}</p>
            <p style="font-size:25px;color:#f68b1c;">{{y}}元</p>
            ...
            <li style="background:#e6e6e6;height:0.13rem;width:100%;margin-left:0">
             ...
             <li class="meiyong" @click="tica">
                ...
                <div style="margin-right:4%;">
                    ...
                    <img src="../../static/image/arr.png" style="vertical-align: middle;margin-top:-2px;margin-right:-2px;width: 0.07rem;
    height: 0.12rem;"></img>
                </div>
            </li>
             <li class="meiyong" @click="deduction">
                <div style="sanli">积分抵扣</div>
                <div style="margin-right: 4%;">
                    <span>积分抵扣{{this.$route.query.val?(this.$route.query.val)/100:0}}元</span>
                    <img src="../../static/image/arr.png" style="vertical-align: middle;margin-top:-2px;margin-right:-2px;width: 0.07rem;
                    height: 0.12rem;"></img>
                </div>
...
export default {
    ...
    methods:{
        deduction(){
            this.$router.push({path:'/shengcheng'})
        },
        // addf(){
        ...
        tica(){
            this.$router.push({path:'/fuzhi',query:{num:6}})
        },
        rightnow(){
            // /Park/pay
            console.log(sessionStorage.getItem('ticknumbar3'))
            ...
            that.$http({
                ...
                if (typeof WeixinJSBridge == "undefined"){
                        ...
                        that.$http({
                            ...
                            MessageBox('提示', '本次停车免费').then(action=>{
...
<style scoped>
    .table{
        width:100%;margin:0 auto;line-height:0.4rem;text-align:center;padding-top:0.22rem;
