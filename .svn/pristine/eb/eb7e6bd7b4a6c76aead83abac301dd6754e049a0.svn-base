...
<style>
	...
	.loginHeader>.content{display: flex;}
	.loginHeader>.content>div{height: 100%;font-size: 16px;line-height: 62px;}
	.loginHeader>.content>div>img{margin: 13px 0;margin-right: 10px;}
