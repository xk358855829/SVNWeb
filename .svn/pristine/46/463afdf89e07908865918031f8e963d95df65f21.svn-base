...
<style scoped="scoped">
	...
	.center{height: 85%;text-align: center;}
	.center>p{font-size: 0.36rem;color: #FFFFFF;margin-bottom: 0.52rem;padding-top: 2%;}
	.centerMain{width: 4.24rem;height: 2.64rem;background-color:rgba(195,195,195,0.5); border-radius:0.2rem;margin: auto;text-align: center;padding: 0.46rem 0;}
