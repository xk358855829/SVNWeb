<template>
  <footer>
    <div class="first"
         @click="abc('/home')"
         :class="{Colorclick:1==Colors}">
      <p>
        <img :src="Wacth==1?require('../../../static/image/home.png'):require('../../../static/image/homes (1).png')"
             alt="">
      </p>
      <span>首页</span>
    </div>
    ...
    <div class="second"
         @click="abc('/geren')"
         :class="{Colorclick:2==Colors}">
      <p>
        <img :src="Wacth==2?require('../../../static/image/mes.png'):require('../../../static/image/me.png')"
             alt="">
      </p>
      <span>取钥匙</span>
    </div>
...
span {
  @include sc(10px, rgb(180, 180, 180));
}
</style>
