    ...
    <el-dialog title="查看"
      ...
      <div slot="footer"
        ...
        <el-button type="success"
                   class="oyButton"
                   v-if="typeValue"
                   @click="changecontrol(con)">设备控制</el-button>
        <el-button type="success"
                   class="oyButton"
...
        })
    ...
    changecontrol (val) {
      ...
      let sn=val.devParaSn;
      if(sn.substr(0,2)=='03'){
        this.contorName="现场维护"
      }else{
        this.contorName="布防状态"
      }
      console.log(val)
      let that = this;
      let data = {
